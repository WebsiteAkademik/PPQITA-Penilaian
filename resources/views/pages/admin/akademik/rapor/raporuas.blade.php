    ...
    <div class="row">
        <div class="col-lg-12 d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body">
                    <h5 class="card-title fs-6 fw-semibold mb-4">Rapor UAS</h5>
                    @if(session('success'))
                                ...
                                <tr>
                                    ...
                                    <td class="border-bottom-0 align-items-center text-center">
                                        <div class="row col-6 d-flex justify-content-center" style="width: 100px; margin: 0 auto">
                                            <a href="{{ route('raporuas.cetak', $row->id) }}" target="_blank" class="btn btn-success m-3" id="cetakRapor">Cetak Rapor</a>
                                        </div>
                                    </td> 
                                </tr>
                                @endforeach
