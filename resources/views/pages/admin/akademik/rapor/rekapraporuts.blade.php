...
@push('script')
    ...
    <script>
        $(document).ready(function() {
            new DataTable('#table-rekaprapor', {
                "oLanguage": {
    ...
    <div class="row">
        <div class="col-lg-12 d-flex align-items-stretch">
            <div class="card w-100">
                <div class="card-body">
                    <h5 class="card-title fs-6 fw-semibold mb-4">Rekap Rapor UTS</h5>
                    <div class="table-responsive">
                        <table class="table text-nowrap mb-0 align-middle" id="table-rekaprapor">
                                ...
                                <tr>
                                    ...
                                    <td class="border-bottom-0 align-items-center text-center">
                                        <div class="row col-6 d-flex justify-content-center" style="width: 100px; margin: 0 auto">
                                            <a href="{{ route('rekapraporuts.index', $row->id) }}" class="text-black text-center d-flex align-items-center justify-content-center" style="width: 40px;height: 40px;"><i class="fa-solid fa-pen-to-square"></i></a>
                                        </div>
                                    </td> 
                                </tr>
                                @endforeach
