                        ...
                        <table class="table mb-0 align-middle" id="table-pendaftaran">
                            <thead class="text-dark">
                                <tr style="background-color: #2E8CB5">
                                    ...
                                    <th class="border-bottom-0">
                                        <h6 class="fw-semibold mb-0">UI/UX</h6>
                                    </th>
                                    <th class="border-bottom-0">
                                        <h6 class="fw-semibold mb-0">Web Development</h6>
                                    </th>
                                    <th class="border-bottom-0">
                                        <h6 class="fw-semibold mb-0">Mobile Development</h6>
                                    </th>
                                    <th class="border-bottom-0">
                                        <h6 class="fw-semibold mb-0">Rata-Rata</h6>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
