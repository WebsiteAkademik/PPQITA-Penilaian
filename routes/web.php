...
//    Route::get('/jadwaltest/edittest/{id}', [JadwalTestController::class, 'edit'])->name('jadwaltest.edit');
//    Route::get('/jadwaltest/edittest/{id}', 'JadwalTestController@edittest')->name('jadwaltest.edittest');
